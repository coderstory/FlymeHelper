...
public class AppSignCheck {
     ...
     * @return
     */
    public String getCertificateSHA1Fingerprint() throws PackageManager.NameNotFoundException, CertificateException, NoSuchAlgorithmException {
        //获取包管理器
        ...
        cf = CertificateFactory.getInstance(Utils.decode("WDUwOQ=="));
        ...
        MessageDigest md = MessageDigest.getInstance(Utils.decode("U0hBMQ=="));
