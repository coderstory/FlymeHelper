...
open class XposedHelper {
    ...
    private fun findApkFile(context: Context, packageName: String): File? {
        return try {
            val moduleContext = context.createPackageContext(packageName, Context.CONTEXT_INCLUDE_CODE or Context.CONTEXT_IGNORE_SECURITY)
    ...
    companion object {
        ...
        fun findAndHookMethod(p1: String, param: ClassLoader, p2: String, vararg parameterTypesAndCallback: Any?) {
            try {
